...
export const getClipboardText = (status: string, nicheName = "") => {
  ...
  switch (status) {
    ...
    case "Надіслали сайт":
      return `Доброго ${dayTime}, даруйте, що так пізно, потрібно було закінчити попередній сайт. Ось покликання, Розетка блокує, якщо кидати повним, для зручності, можу кинути у ТГ або Вайбер`
    default:
      return null
  }
}
